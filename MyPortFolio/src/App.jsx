          ...
          <div className="home-content">
            ...
            <div className="typewriter-container">
              ...
              <div className="typewriter-text anton-sc-regular">
                <Typewriter
                  options={{
                    strings: ["Full Stack Developer", "MERN Stack Developer", "Competitive Programmer"],
                    autoStart: true,
                    loop: true,
                  }}
                />
        ...
        <section id="about" className="about-section">
          <div className="about-content">            
            ...
            <h1 className='anton-sc-regular'>About Me</h1>
              ...
              <a href="https://leetcode.com/u/BuRNedS/" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://www.geeksforgeeks.org/user/burneds/" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48" className="gfg-icon">
...
<section id="skills" className="skills-section">
  ...
  <div className="skills-container">
    {[
      ...
      'github', 'sql', 'firebase', 'c', 'cpp', 'python', 'java'
    ].map(skill => (
        ...
        <section id="hireme" className="hireme-section raleway-desc">
          <div className="contact-info">
            ...
            <div className="contact-item">
              ...
              <p>satyamsundram360@gmail.com</p>
            </div>
            <div className="contact-item">
          ...
          <div className="contact-form">
            <form action="mailto:satyamsundram360@gmail.com" method="post" enctype="text/plain">
